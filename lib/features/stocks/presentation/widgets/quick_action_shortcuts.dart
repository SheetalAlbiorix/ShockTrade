...
class QuickActionShortcuts extends StatelessWidget {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildShortcut(context, 'Watchlist', Icons.remove_red_eye_outlined, Colors.purple),
  ...
  Widget _buildShortcut(BuildContext context, String label, IconData icon, Color color) {
    return Column(
      children: [
        Container(
          width: 60,
